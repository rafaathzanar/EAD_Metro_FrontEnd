...
function InventoryStockList() {
  ...
  return (
    <div className="bg-gray-100 rounded-3xl p-8 m-4 xl:w-[85rem] w-full mx-auto shadow-lg">
        ...
        <h2 className="md:text-3xl font-semibold text-gray-800 sm:text-base">Stock List</h2>
        <button className="bg-[#f29425] hover:from-orange-400 hover:to-yellow-300 text-white font-semibold py-2 px-4 sm:py-3 sm:px-6 rounded-full shadow-xl transition-transform hover:scale-105 flex items-center">
  ...
  />
        ...
        <Table stockList={TempStock} onEdit={handleEdit} onDelete={handleDelete} />
    </div>
  );
}
